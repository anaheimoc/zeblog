...
<?php } ?>
  ...
  <p class="credits"><?php print t("Powered by !drupal and the !name theme by !author.", array('!drupal' => '<a href="http://www.drupal.org">Drupal</a>', '!name' => '<a href="http://www.drupal.org/project/barlow">Barlow</a>', '!author' => '<a href="http://egonbianchet.net">Egon Bianchet</a>')) ?></p>
</div>

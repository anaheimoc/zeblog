...
function barlow_preprocess_node(&$variables, $hook) {
  ...
  $function = 'fusion_anaheimoc_preprocess_node'.'_'. $variables['node']->type;
  if (function_exists($function)) {
   $function(&$variables);
  }
}

function barlow_preprocess_node_blog_article(&$variables){
	$node = $variables['node'];
	$variables['sweet'] = 'Happy time!';
}
